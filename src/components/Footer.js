...
const Footer = () => (
    <Flex align="center" justifyContent="center" flexDirection="column">
            <Flex align="center" width={{ base: "100%", sm: "100%", md: "1440px" }} overflow="hidden" flexDirection="column" >
                {/* <Parallax  styleOuter={{ width: '100%',}} className="custom-class" y={[-30, 50]}> */}
                    <Box
                        ...
                        bgRepeat="no-repeat"
                        width={{ base: "100%", sm: "100%", md: "1440px" }} height={{ base: "500px", sm: "500px", md: "600px" }}
                        position="relative"
                ...
                {/* </Parallax> */}
                <Box py="20px" bgColor="#A3B0B7" color="#fff" w="100%" fontSize="20px" textAlign="center">Copyright © SHIKAMARO All Rights Reserved. </Box>
            </Flex>
    </Flex>
  );
